...
export default function MerchantDashboard({
  ...
  const handleSendAgentMessage = async (promptText?: string) => {
    ...
    // Moteur de réponse mock (inchangé)
    ...
    // 2. Enregistre la réponse de l'assistant dans Supabase
                              ...
                              {trashedProjects.map((proj) => (
                                ...
                                >
                                  <div className="space-y-1 min-w-0 flex-1">
                                    ...
                                    <p className="text-[11px] text-slate-400">
                                      {proj.created_at
                                        ? `Créé le ${new Date(proj.created_at).toLocaleDateString('fr-FR', { day: '2-digit', month: 'short', year: 'numeric' })}`
                                        : 'En corbeille'}
                                    </p>
                                  </div>
            ...
            <form
              onSubmit={async (e) => {
                ...
                if (isNaN(feeNum) || feeNum < 0) {
                  alert('Les frais de livraison doivent être un montant valide supérieur ou égal à 0.');
                  return;
                }
                ...
                try {
                  if (editingZone.id) {
                    ...
                    if (!res.success) {
                      alert(`Erreur lors de la modification de la zone : ${res.error || 'Échec de la mise à jour'}`);
                      return;
                    }
                    if (res.zone) {
                    ...
                    if (!res.success) {
                      alert(`Erreur lors de l'ajout de la zone : ${res.error || "Échec de l'insertion"}`);
                      return;
                    }
                    if (res.zone) {
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (!res.success) {
                      alert(`Erreur lors de la suppression de la zone : ${res.error || 'Échec de la suppression'}`);
                      return;
                    }
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 space-y-4 text-slate-800">
            ...
            <div className="flex items-center justify-end space-x-2 pt-2 border-t border-slate-100">
              ...
              <button
                ...
                onClick={async () => {
                  if (cancellingOrderId && cancellationReasx���Mn�0���b�M���Di����70�,OdO ��H�HH�z�o<o�ߐK؛m�pA�	ȋ0W.Ek�[/�F�/0~�}��0����0�k���-�з��r_��=��l�� ��2Geʆ!���ywt�
k��q�,b����8e�p�����׬�F�U!|�-����������S@�8���v觿�&���������A>L��d��F�ȱ\��,x*�F-Ki�y��q�^t�^�;�n�����8E�$��)�9���m]�7�\���ƫ��\{�l���u@�7�gV/�}  �� þ�5